...
import org.testcontainers.shaded.com.google.errorprone.annotations.RestrictedApi;
...
class ProductServiceApplicationTests {
    ...
    //connection to the Test MongoDbContainer
    @ServiceConnection
    static MongoDBContainer mongoDBContainer = new MongoDBContainer("mongo:latest"); //bound to class level

    @LocalServerPort
    private Integer port; //this is going to be a random port because of the RANDOM_PORT
